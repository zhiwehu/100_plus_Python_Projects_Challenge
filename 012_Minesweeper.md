...
2. It'll open a Python window to play the Minesweeper game.
...
Please save the Python as minesweeper.py and run it in console：

```
python minesweeper.py
```

![Chanllenge 10](images/012_minesweeper.png)
...
将代码保存为minesweeper.py，然后在控制台运行：

```
python minesweeper.py
```

![挑战12](images/012_minesweeper.png)
